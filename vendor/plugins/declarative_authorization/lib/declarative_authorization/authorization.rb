...
module Authorization
  ...
  class Engine
    ...
    # 2010-8-24 1:04
    #############
    @@need_load_auth_rules = false
    def self.need_load_auth_rules
      @@need_load_auth_rules
    end
    def self.need_load_auth_rules=(b)
      @@need_load_auth_rules = b
    end
    #############
    ...
    def self.instance (dsl_file = nil)
      ...
      # hacked by Tracy
      # 2010-8-24 12:59
      if self.need_load_auth_rules
        self.need_load_auth_rules = false
        @@instance = new
      else
        @@instance ||= new
      end
