  ...
  module ByPassword
    ...
    def self.included(recipient)
      ...
      recipient.class_eval do
        ...
        validates_confirmation_of :password,                   :if => :password_required?, :message => '两次输入密码不一致'
        validates_length_of       :password, :within => 6..40, :if => :password_required?, :message => '密码长度在6～40之间'
